...
def set_config():
    ...
    parser.add_argument('--data-path', type=str, default='D:\MEEG')
    parser.add_argument('--subjects', type=int, default=32)##原来是32
    ...
    # Training Process
    parser.add_argument('--fold', type=int, default=10)##原来是10折
    parser.add_argument('--random-seed', type=int, default=3407)
    parser.add_argument('--max-epoch', type=int, default=200)##原来是200
    ...
    parser.add_argument('--learning-rate', type=float, default=1e-4)  # 学习率 原始值为1e-3
