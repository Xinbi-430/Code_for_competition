...
class GraphNeuralNetwork(nn.Module):
    ...
    def forward(self, x, adj, edge_index=None, edge_attr=None):
...
class ATCNet(nn.Module):
    ...
    def forward(self, x, edge_index=None, edge_attr=None):  # (64,1,32,800)
...
class Linear(nn.Module):
    ...
    def forward(self, inputs, edge_index=None, edge_attr=None):
...
class Chebynet(nn.Module):
    ...
    def forward(self, x, L, edge_index=None, edge_attr=None):
        device = x.device
